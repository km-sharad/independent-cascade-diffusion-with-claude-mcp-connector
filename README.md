...
<ul>
<li>What nodes in the network are easy to influence and convert and which ones are hard?</ul>li>
...
<li>If it takes $50 to activate odd number nodes and $100 to activate even number nodes, which method is the most economical to reach at least 2000 people (where people are nodes in the graph).</li>
<ul>
